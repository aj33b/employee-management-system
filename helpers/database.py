...
CREATE_EMPLOYEES_TABLE_QUERY = """CREATE TABLE employees(
    id SERIAL PRIMARY KEY ,
    name VARCHAR(100),
    age INT,
...
SEED_ADMIN_USER_QUERY = """INSERT INTO users (username,password, role) VALUES ('admin','8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918','admin');"""
...
class Database:
    ...
    def connect_database_server(self):
        try:
            ...
            print(f"Could not connect to the database server: {e}")
    ...
    def setup_database(self):
        ...
        try:
            ...
            cursor.execute(SEED_ADMIN_USER_QUERY)
            self.close()
